    ...
    <div class="container py-md-5">
        ...
        <div class="row blog-grids">
            <?php foreach ($home['product_service'] as $val) { ?>
                <div class="col-lg-4 col-md-6 blog-left mb-lg-0 mb-sm-5 pb-lg-0 pb-5" style="margin-top: 5%">
                    <img src="<?php echo base_url($val['Image']) ?>" class="img-fliud" alt=""/>
                    <div class="blog-info" style="background-color: yellowgreen">
                        <h4 style="font-size: 105%"><?php echo $val['Description'] ?><span
    ...
    <div class="container py-md-4">
        ...
        <div class="row core-grids">
            ...
            <div class="col-lg-6 core-right">
                <p class="mt-4" Style="font-size:15px;color:Black"><?php echo $home['our_process']['Description'] ?></p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-lg-3 col-md-5 bg-right mt-lg-0 mt-4">
                    <ul>
                        <?php foreach ($home['turn_your_garden'] as $val) { ?>
                            <li><span class="<?php echo $val['Page_icon'] ?>"></span><?php echo $val['Description'] ?>
                            </li>
                        <?php } ?>
